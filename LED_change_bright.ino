...
int control_white = 0;
int control_rgb = 0;
int white_brightness = 0; // Biến lưu độ sáng
...
void callback(char* topic, byte* message, unsigned int length) {
  ...
  if (String(topic) == "message/control/white") {
    ...
    else if(messageTemp.startsWith("dim:")){
      control_white = 1;
      white_brightness = messageTemp.substring(4).toInt();
      analogWrite(WARM_WHITE, white_brightness);
      send_message_mqtt("white", "dim:" + String(white_brightness));
    }
  }
